...
entry:
  ...
  store i64 %add, ptr %f, align 8, !dbg !34
    #dbg_declare(ptr %i, !38, !DIExpression(), !40)
...
entry:
  ...
  store i32 0, ptr %retval, align 4
    #dbg_declare(ptr %a, !67, !DIExpression(), !68)
  ...
  %call3 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %1), !dbg !75
    #dbg_declare(ptr %b, !76, !DIExpression(), !77)
